...
class LaserMerger
{
	...
	void pointcloud_to_laserscan(Eigen::MatrixXf points, sensor_msgs::PointCloud2 *merged_cloud);
...
void LaserMerger::pointcloud_to_laserscan(Eigen::MatrixXf points, sensor_msgs::PointCloud2 *merged_cloud)
{
